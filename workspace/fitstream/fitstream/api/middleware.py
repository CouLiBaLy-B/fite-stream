...
class APIKeyAuth:
    ...
    def __init__(self, keys: list | None = None, enabled: bool = False) -> None:
...
class APIMetrics:
    ...
    def get_summary(self) -> dict:
        ...
        return {
            ...
            "avg_generation_time": (self.total_generation_time / max(1, self.total_generations)),
...
class RequestLoggingMiddleware(BaseHTTPMiddleware):
    ...
    def __init__(self, app, metrics: APIMetrics | None = None) -> None:
        super().__init__(app)
        ...
        try:
            ...
            if not skip_log:
                status_emoji = (
                    ...
                    else "⚠️" if response.status_code < 500 else "❌"
                )
                logger.info(
