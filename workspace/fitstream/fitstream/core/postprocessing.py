...
class PostProcessor:
    ...
    def stabilize(
        ...
        try:
            ...
            cmd1 = [
                ...
                input_path,
                "-vf",
                f"vidstabdetect=shakiness={shakiness}:result={transforms_file}",
                "-f",
                "null",
                "-",
            ]
            ...
            cmd2 = [
                ...
                input_path,
                "-vf",
                f"vidstabtransform=input={transforms_file}:smoothing=10,unsharp=5:5:0.8:3:3:0.4",
                "-c:v",
                "libx264",
                "-crf",
                "20",
    ...
    def add_watermark(
        ...
        cmd = [
            ...
            input_path,
            "-vf",
            f"drawtext=text='{text}':fontsize={font_size}:fontcolor=white@{opacity}:{pos}",
            "-c:v",
            "libx264",
            "-crf",
            "20",
