...
class ExportPipeline:
    ...
    def to_gif(
        ...
        try:
            ...
            cmd2 = [
                ...
                "-lavfi", f"fps={fps},scale={max_width}:-1:flags=lanczos[x];[x][1:v]paletteuse=dither=bayer",
                "-loop", str(loop),
                output_path,
            ]
    ...
    def to_social(
        ...
        try:
            ...
            if add_watermark:
                vf += f",drawtext=text='{watermark_text}':fontsize=20:fontcolor=white@0.5:x=10:y=H-30"
