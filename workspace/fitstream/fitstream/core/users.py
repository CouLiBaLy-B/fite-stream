...
class UserManager:
    ...
    def get_share(self, share_id: str) -> Optional[SharedVideo]:
    ...
    def revoke_api_key(self, user_id: str) -> Optional[str]:
        ...
        try:
            data = {
                "users": {uid: {
                    ...
                    "api_key_hash": u.api_key_hash, "role": u.role,
                ...
                "shares": {sid: {
                    "share_id": s.share_id, "job_id": s.job_id,
                    "user_id": s.user_id, "video_path": s.video_path,
                    "prompt": s.prompt, "created_at": s.created_at,
                    "views": s.views, "expires_at": s.expires_at,
