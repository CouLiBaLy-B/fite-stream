...
class PreprocessingEngine:
    ...
    def analyze_image(self, image_path: str | Path) -> ImageAnalysis:
        """
        ...
        if w < 400 or h < 400:
            ...
            recommendations.append(
                "Use a higher resolution image (at least 800px on shortest side)"
            )
    ...
    def create_quality_report(self, analysis: ImageAnalysis) -> str:
        ...
        lines.append(
            f"   Resolution: {analysis.width}×{analysis.height} ({'portrait' if analysis.is_portrait else 'landscape'})"
        )
