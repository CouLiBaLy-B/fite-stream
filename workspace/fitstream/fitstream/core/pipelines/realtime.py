...
class RealTimePipeline(BasePipeline):
    ...
    def __init__(
        ...
        rt_config: RealTimeConfig | None = None,
    ) -> None:
    ...
    def generate_fast(
        ...
        try:
            if self._fc_available:
                return self._generate_fc(
                    image_path, prompt, output_path, seed, num_frames, start_time
                )
            else:
    ...
    def get_status(self) -> dict:
        ...
        return {
            ...
            "note": (
                "FashionChameleon real-time mode ready!"
                if self._fc_available
