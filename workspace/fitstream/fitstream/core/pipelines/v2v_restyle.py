...
from fitstream.core.utils.video_utils import get_video_info, save_video
    ...
    def restyle(
        ...
        if info.get("duration", 0) <= 0:
            return V2VResult(
                ...
                prompt_used="",
                success=False,
                error="Cannot read source video",
            )
        ...
        if prompt:
            ...
            base_prompt = "Restyle this video scene"
        ...
        try:
            ...
            source_frames = self._extract_frames(
                video_path, max_frames=self.config.animate.num_frames
            )
