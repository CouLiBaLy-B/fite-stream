...
class LoomNativePipeline(BasePipeline):
        ...
        if loom_path.exists():
            ...
            if has_weights:
                ...
                try:
                    ...
                    logger.info(
                        "LoomVideo weights found but code not installed — using Diffusers mode"
                    )
    ...
    def generate(  # type: ignore[override]
        ...
        if output_path is None:
            ...
            output_path = os.path.join(
                self.config.output_dir, f"loom_native_{timestamp}_{seed}.mp4"
            )
    ...
    def _generate_native(
        self, images, prompt, output_path, w, h, nf, steps, guidance, seed, t0
    ) -> LoomResult:
