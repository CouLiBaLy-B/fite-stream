...
@click.option("--style", default="cinematic", help="Visual style (cinematic, photorealistic, anime, etc.)")
...
@click.option("--output", "-o", default=None, help="Output video path")
@click.option("--category", type=click.Choice(["auto", "upper", "lower", "dress", "shoes", "accessories"]), default="auto")
...
@main.command()
@click.option("--images", "-i", required=True, multiple=True, help="Reference images (use multiple -i)")
