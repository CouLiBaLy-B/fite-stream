...
class TestV2VRestylePipeline:
    ...
    def test_result_dataclass(self):
        r = V2VResult(
            video_path="/out.mp4", source_path="/in.mp4",
            style="Ghibli", strength=0.7, num_frames=49,
            duration_seconds=3.0, resolution="832x480",
            generation_time=42.0, seed=123,
            prompt_used="test", success=True,
        )
    ...
    def test_failed_result(self):
        r = V2VResult(
            video_path="", source_path="/in.mp4",
            style="Noir", strength=0.7, num_frames=0,
            duration_seconds=0, resolution="",
            generation_time=0, seed=0,
            prompt_used="", success=False, error="OOM",
        )
